...
namespace AutoTrader
{
    ...
    public class CtpTraderApi
    {
        ...
        public void LoadDll(string strFile)
        {
            ...
            this.PtrHandle = LoadLibrary(dir + "\\CtpTraderApi.dll");
        ...
        public void UnLoadDll()
        {
            ...
            catch (System.Exception ex)
            {
                ...
                Util.WriteError("exception: " + ex.StackTrace);
            }
        }
        ...
        public int OrderInsert(string instrumentId, EnumThostDirectionType direction, double price, int nVolume, EnumThostOffsetFlagType openOrClose, string orderRef, EnumOrderType orderType = EnumOrderType.Limit)
        {
            CThostFtdcInputOrderField pOrder = new CThostFtdcInputOrderField();
            pOrder.BrokerID = BrokerID;
            ...
            //{
            //    pOrder.ContingentCondition = EnumContingentConditionType.Immediately;
            //    pOrder.LimitPrice = price;
            //    pOrder.OrderPriceType = EnumOrderPriceTypeType.LimitPrice;
            //    pOrder.StopPrice = touchPrice;
            //    pOrder.TimeCondition = EnumTimeConditionType.GFD;
            //}
            //else if (orderType == EnumOrderType.MIT)//ToDo
            //{
            //    pOrder.ContingentCondition = EnumContingentConditionType.Immediately;
            //    //pOrder.LimitPrice = Price;
            //    pOrder.OrderPriceType = EnumOrderPriceTypeType.BestPrice;
            //    pOrder.StopPrice = touchPrice;
            //    pOrder.TimeCondition = EnumTimeConditionType.GFD;
            //}
            return ((reqOrderInsert)Invoke(this.PtrHandle, "ReqOrderInsert", typeof(reqOrderInsert)))(ref pOrder);
