...
///批量报单操作请求
TRADEAPI_API int ReqBatchOrderAction(CThostFtdcInputBatchOrderActionField *pInputBatchOrderAction)
{
	return pUserApi->ReqBatchOrderAction(pInputBatchOrderAction, ++iRequestID);
}

///请求查询产品组
TRADEAPI_API int ReqQryProductGroup(CThostFtdcQryProductGroupField *pQryProductGroup, int nRequestID)
{
	return pUserApi->ReqQryProductGroup(pQryProductGroup, ++iRequestID);
}
...
///请求查询做市商期权合约手续费
TRADEAPI_API int ReqQryMMOptionInstrCommRate(CThostFtdcQryMMOptionInstrCommRateField *pQryMMOptionInstrCommRate, int nRequestID)
{
	return pUserApi->ReqQryMMOptionInstrCommRate(pQryMMOptionInstrCommRate, ++iRequestID);
}

///请求查询报单手续费
TRADEAPI_API int ReqQryInstrumentOrderCommRate(CThostFtdcQryInstrumentOrderCommRateField *pQryInstrumentOrderCommRate, int nRequestID)
{
	return pUserApi->ReqQryInstrumentOrderCommRate(pQryInstrumentOrderCommRate, ++iRequestID);
}
